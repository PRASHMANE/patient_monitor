...
# ==============================
    ...
    # ------------------------------
    model_path = "LRCN_model_saved.h5"  # Put your trained model in current directory
    ...
    if start_button:
        ...
        while True:
            ...
            cv2.putText(display_frame,
                ...
                (5, 80),   # move down a bit so big text fits
                cv2.FONT_HERSHEY_SIMPLEX,
                2.5,       # ⬅️ bigger size (try 2 or 3)
                (0, 0, 255),
                8,         # ⬅️ thicker font for visibility
                cv2.LINE_AA)
